...
class CertificationControllerSpec extends Specification implements ControllerUnitTest<CertificationController>, DomainUnitTest<Certification> {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.certificationService = Mock(CertificationService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.certificationService = Mock(CertificationService) {
            1 * save(_ as Certification) >> { Certification certification ->
                throw new ValidationException("Invalid instance", certification.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.certification instanceof Certification
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Certification())
