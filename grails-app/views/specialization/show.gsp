            ...
            <div class="card-body">
                ...
                <f:with bean="specialization">
                    <div class="row imarDisplaySection">
                        <div class="col-md-4">
                            <label for="name">Spec Prefix : </label>
                            <f:display  property="prefix" /><br>
                            <label for="address">Spec Name : </label>
                            <f:display  property="name" /><br>
                        </div>
                        <div class="col-md-4">
                            <label for="visitedFactory">Industry Prefix : </label>
                            <f:display property="industry.prefix"/><br>
                            <label for="haveMetRepresentative">Industry Name : </label>
                            <f:display property="industry.name"/><br>
                        </div>
                    ...
                    <div class="col-md-4">
                        <g:form resource="${this.specialization}" method="DELETE">
                            <fieldset class="buttons">
                                <g:link class="edit btn btn-warning btn-lg" action="edit" resource="${this.specialization}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
