...
<html>
    ...
    <body>
        <a href="#edit-certification" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-certification" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.certification}" method="PUT">
