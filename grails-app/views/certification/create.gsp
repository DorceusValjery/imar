...
<html>
    ...
    <body>
        <a href="#create-certification" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-certification" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.certification}" method="POST">
                <fieldset class="form">
                    <f:all bean="certification"/>
                </fieldset>
